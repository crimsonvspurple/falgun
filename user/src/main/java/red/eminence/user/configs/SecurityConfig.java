...
//    {
//        Stream<Endpoint> publicEndpoints = List.of(new Endpoint(HttpMethod.POST, "/v1/auth"),
...
//                                                   new Endpoint(HttpMethod.GET, "/v1/seeder")).parallelStream();
...
//                    // allow all public GETs
//                    .pathMatchers(HttpMethod.GET, publicEndpoints.filter(endpoint -> endpoint.method.equals(HttpMethod.GET)).map(endpoint -> endpoint.path).toArray(String[]::new)).permitAll()
//                    // allow all public POSTs
//                    .pathMatchers(HttpMethod.POST, publicEndpoints.filter(endpoint -> endpoint.method.equals(HttpMethod.POST)).map(endpoint -> endpoint.path).toArray(String[]::new)).permitAll()
